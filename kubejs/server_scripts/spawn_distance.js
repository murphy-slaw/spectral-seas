...
PlayerEvents.tick(event => {
    ...
    if (event.player.age % 20 === 0) {
        ...
        if (!distanceObjective) {
            distanceObjective = event.server.scoreboard.addObjective("spawnDistance",
        ...
        let score = scoreboard.getOrCreatePlayerScore(event.player.username, distanceObjective);
