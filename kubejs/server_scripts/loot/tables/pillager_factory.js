...
LootJS.modifiers((event) => {
    Loot.smartReplacePools(event, 'mostructures:factory/supply', [rawMaterials])
    Loot.smartReplacePools(event, 'mostructures:factory/finished', [finishedGoods])
    Loot.smartReplacePools(event, 'mostructures:factory/overseer', [overseerChest])
})
