...
LootJS.modifiers(event => {
    Loot.smartReplacePools(event, 'minecraft:chests/pillager_outpost', [lookout_post])
    Loot.smartReplacePools(event, 'kaisyn:outpost/common/armory', [armory_cache])
    Loot.smartReplacePools(event, 'kaisyn:outpost/common/food', [supply_chest])
})
