...
LootJS.modifiers((event) => {
    Loot.smartReplacePools(event, 'minecraft:chests/jungle_temple', [hunter, shaman, tribalWealth])
    Loot.smartReplacePools(event, 'mostructures:jungle_temple_treasure', [
        hunter,
        shaman,
        tribalWealth,
    ])
    Loot.smartReplacePools(event, 'mvs:jungle_tower', [shaman, tribalWealth])
})
