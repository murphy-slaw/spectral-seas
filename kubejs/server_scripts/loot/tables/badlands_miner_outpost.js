...
LootJS.modifiers((event) => {
    ...
    Loot.smartReplacePools(event, 'nova_structures:chests/badland_miner_outpost', [lookoutPost])
    Loot.smartReplacePools(event, 'nova_structures:chests/pillager_outpost_treasure', [lookoutPost])
    Loot.smartReplacePools(event, 'nova_structures:chests/mining_supply', [miningSupply])
    Loot.smartReplacePools(event, 'minecraft:chests/abandoned_mineshaft', [miningSupply])
